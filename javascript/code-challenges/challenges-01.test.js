...
const addOne = (arr) => {
  // Solution code here...
  const arrPlusOne = [];
  arr.forEach( num => arrPlusOne.push(num + 1));
  return arrPlusOne;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  const arrOutput = [];
  arr.forEach( str => arrOutput.push(str + '!'));
  return arrOutput;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  const arrOutput = [];
  arr.forEach( str => arrOutput.push(str.toUpperCase()));
  return arrOutput;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  const arrOutput = [];
  words.forEach(word => arrOutput.push(callback(word)));
  return arrOutput;
};
...
const createList = (availableItems) => {
  // Solution code here...
  const arrOutput = [];
  availableItems.forEach(item => item.available ? arrOutput.push(item.name) : null);
  return arrOutput;
};
