...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((initialCount, currentValue) => {
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((initialArray, currentValue) => {
    initialArray.push(currentValue.name);
    return initialArray;
  }, []);
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((initialArray, currentValue) => {
    initialArray.unshift(currentValue);
    return initialArray;
  }, []).join('');
};
